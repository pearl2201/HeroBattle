...
namespace MasterServer.Filters
{
        ...
        public ApiExceptionFilterAttribute()
        {
            ...
            _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext>>
            {
                ...
                { typeof(ForbiddenAccessException), HandleForbiddenAccessException },
                 { typeof(UnavailableFeatureException), HandleUnavailableFeatureException }
            };
        }


        private static void HandleUnavailableFeatureException(ExceptionContext context)
        {
            var details = ServiceResult.Failed(ServiceError.FeatureNotAvailable);
