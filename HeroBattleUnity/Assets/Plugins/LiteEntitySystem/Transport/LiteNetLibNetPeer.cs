...
namespace LiteEntitySystem.Transport
{
    public class LiteNetLibNetPeer : AbstractNetPeer
    {
        ...
        public override void SendReliableOrdered(ReadOnlySpan<byte> data) => NetPeer.Send(data.ToArray(), 0, DeliveryMethod.ReliableOrdered);
        public override void SendUnreliable(ReadOnlySpan<byte> data) => NetPeer.Send(data.ToArray(), 0, DeliveryMethod.Unreliable);
