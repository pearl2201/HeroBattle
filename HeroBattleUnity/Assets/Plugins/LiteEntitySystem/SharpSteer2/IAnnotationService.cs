...
namespace SharpSteer2
{
	...
	public interface IAnnotationService
	{
	    ...
	    void Line(Vector3f startPoint, Vector3f endPoint, Vector3f color, float opacity = 1);
        ...
        void CircleXZ(float radius, Vector3f center, Vector3f color, int segments);
        ...
        void DiskXZ(float radius, Vector3f center, Vector3f color, int segments);
		...
		/// <param name="color">The color of the circle.</param>
		/// <param name="segments">The number of segments to use to draw the circle.</param>
        void Circle3D(float radius, Vector3f center, Vector3f axis, Vector3f color, int segments);
		...
		/// <param name="color">The color of the disk.</param>
		/// <param name="segments">The number of segments to use to draw the disk.</param>
        void Disk3D(float radius, Vector3f center, Vector3f axis, Vector3f color, int segments);
        ...
        void CircleOrDiskXZ(float radius, Vector3f center, Vector3f color, int segments, bool filled);
		...
		/// <param name="segments">The number of segments to use to draw the circle/disk.</param>
		/// <param name="filled">Flag indicating whether to draw a disk or circle.</param>
        void CircleOrDisk3D(float radius, Vector3f center, Vector3f axis, Vector3f color, int segments, bool filled);
        ...
        void CircleOrDisk(float radius, Vector3f axis, Vector3f center, Vector3f color, int segments, bool filled, bool in3D);
		...
		void PathFollowing(Vector3f future, Vector3f onPath, Vector3f target, float outside);
		...
		void AvoidNeighbor(IVehicle threat, float steer, Vector3f ourFuture, Vector3f threatFuture);
